					...
					<div class="card-content">
						<table class="bordered">
							<thead>
								...
								<!--  ログインしているIDと一致するIDのt_buyのデータを個数分繰り返す -->

							<tbody>

               					<c:forEach var="userBuyData" items="${userBuyDataList}" >
									<tr>
										<td class="center"><a href="UserBuyHistoryDetail?id=${userBuyData.buy_id}" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
										<td class="center">${userBuyData.formatDate}</td>
										<td class="center">${userBuyData.deliveryMethodName}</td>
										<td class="center">${userBuyData.totalPrice}円</td>
									</tr>
								</c:forEach>
